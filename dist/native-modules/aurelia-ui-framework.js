...
import { autoinject, computedFrom, Container, singleton, CompositionEngine, ViewCompiler } from 'aurelia-framework';
...
var RESOURCE_LOADER = (_a = {
        viewport: function () { return import('./ui-viewport.js').then(function (m) { return m.Viewport; }); },
        page: function () { return import('./ui-page.js').then(function (m) { return m.Page; }); },
        icons: function () { return import('./ui-icons.js').then(function (m) { return m.Icons; }); },
        responsive: function () { return import('./ui-responsive.js').then(function (m) { return m.Responsive; }); },
        shared: function () { return import('./ui-shared.js').then(function (m) { return m.Shared; }); },
        attributes: function () { return import('./ui-attributes.js').then(function (m) { return m.Attributes; }); },
        valueconverters: function () { return import('./value-converters.js').then(function (m) { return m.ValueConverters; }); }
    },
    _a[UIResources.Buttons] = function () { return import('./ui-buttons.js').then(function (m) { return m.Buttons; }); },
    _a[UIResources.Calendar] = function () { return import('./ui-calendar.js').then(function (m) { return m.Calendar; }); },
    _a[UIResources.Card] = function () { return import('./ui-card.js').then(function (m) { return m.Card; }); },
    _a[UIResources.DataPanel] = function () { return import('./ui-data-panels.js').then(function (m) { return m.DataPanels; }); },
    _a[UIResources.Forms] = function () { return import('./ui-forms.js').then(function (m) { return m.Forms; }); },
    _a[UIResources.Gridder] = function () { return import('./ui-gridder.js').then(function (m) { return m.Gridder; }); },
    _a[UIResources.Lists] = function () { return import('./ui-lists.js').then(function (m) { return m.Lists; }); },
    _a[UIResources.Menus] = function () { return import('./ui-menus.js').then(function (m) { return m.Menus; }); },
    _a[UIResources.Panel] = function () { return import('./ui-panels.js').then(function (m) { return m.Panels; }); },
    _a[UIResources.TabPanel] = function () { return import('./ui-tab-panel.js').then(function (m) { return m.TabPanel; }); },
    _a);
