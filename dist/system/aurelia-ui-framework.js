System.register(['aurelia-framework', 'aurelia-event-aggregator', 'aurelia-logging', 'date-fns', 'kramed', 'numeral', 'libphonenumber-js', 'libphonenumber-js/examples.mobile.json', 'aurelia-validation', 'resize-observer-polyfill', 'aurelia-router', 'aurelia-metadata', 'aurelia-fetch-client'], function (exports, module) {
    'use strict';
    var Container, TaskQueue, BindingEngine, DOM, ViewCompiler, ViewResources, bindable, autoinject, customAttribute, child, computedFrom, customElement, inlineView, bindingMode, children, containerless, viewResources, processContent, observable, valueConverter, ViewSlot, singleton, CompositionEngine, EventAggregator, getLogger, parseISO, isValid, format, toDate, formatDistanceStrict, formatDistance, addDays, addWeeks, addMonths, addYears, startOfDay, startOfWeek, endOfWeek, startOfMonth, endOfMonth, startOfYear, endOfYear, startOfDecade, endOfDecade, isBefore, isAfter, getDay, setDay, isSameMonth, isSameDay, endOfDay, setMonth, getHours, setHours, getMinutes, setMinutes, isSameYear, kramed, numeral, getExampleNumber, AsYouType, parsePhoneNumberFromString, examples, ValidationController, validateTrigger, ValidationRules, ResizeObserver, AppRouter, metadata, json, HttpClient;
    return {
        ...
        execute: function () {
            ...
            ***************************************************************************** */
            ...
            })(UIFormat || (UIFormat = exports('UIFormat', {})));
            ...
            var UIPhone = (function (_super) {
                ...
                UIPhone.prototype.countryChanged = function () {
                    ...
                    var examplePhone = getExampleNumber((this.country || "US"), examples);
                ...
                UIPhone.prototype.update = function (value) {
                    var newInput = new AsYouType(this.country);
            ...
            var Countries$1 = exports('Countries', Countries);
