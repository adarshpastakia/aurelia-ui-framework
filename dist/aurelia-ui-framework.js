define(["require", "exports", 'aurelia-validation', "./utils/ui-validation", "./utils/ui-constants", "./utils/ui-utils", "lodash", "kramed", "moment", "numeral", './utils/ui-application', './utils/ui-constants', './utils/ui-dialog', './utils/ui-event', './utils/ui-format', './utils/ui-http', './utils/ui-model', './utils/ui-tree-model', './utils/ui-utils', 'lodash', 'moment', 'numeral', './libs/countries', './libs/currencies', './libs/filetypes', './libs/phonelib', './libs/window', './elements/core/ui-grid', './elements/core/ui-page', './elements/core/ui-viewport', './elements/inputs/ui-button', './elements/inputs/ui-date', './elements/inputs/ui-form', './elements/inputs/ui-input', './elements/inputs/ui-lists', './elements/inputs/ui-markdown', './elements/inputs/ui-options', './elements/inputs/ui-phone', './elements/inputs/ui-textarea', './elements/components/ui-alerts', './elements/components/ui-bars', './elements/components/ui-breadcrumb', './elements/components/ui-datagrid', './elements/components/ui-dg-columns', './elements/components/ui-drawer', './elements/components/ui-dropdown', './elements/components/ui-menu', './elements/components/ui-panel', './elements/components/ui-sidebar', './elements/components/ui-tab', './elements/components/ui-tree', './value-converters/ui-lodash', './value-converters/ui-text', 'text!./elements/core/framework.html'], function (require, exports, aurelia_validation_1, ui_validation_1, ui_constants_1, ui_utils_1, ld, km, mm, nm, ui_application_1, ui_constants_2, ui_dialog_1, ui_event_1, ui_format_1, ui_http_1, ui_model_1, ui_tree_model_1, ui_utils_2) {
    "use strict";
    function __export(m) {
