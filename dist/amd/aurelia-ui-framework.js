define(['require', 'exports', './_tslib', 'aurelia-framework', 'aurelia-validation', 'libphonenumber-js', './ui-app-config', 'aurelia-event-aggregator', './ui-internal', 'aurelia-logging', 'aurelia-metadata', 'aurelia-fetch-client', 'date-fns', 'kramed', 'numeral', './ui-format'], function (require, exports, _tslib, aureliaFramework, aureliaValidation, libphonenumberJs, uiAppConfig, aureliaEventAggregator, uiInternal, aureliaLogging, aureliaMetadata, aureliaFetchClient, dateFns, kramed, numeral, uiFormat) { 'use strict';
  ...
  var RESOURCE_LOADER = (_a = {
          viewport: function () { return new Promise(function (resolve, reject) { require(['./ui-viewport'], resolve, reject) }).then(function (m) { return m.Viewport; }); },
          page: function () { return new Promise(function (resolve, reject) { require(['./ui-page'], resolve, reject) }).then(function (m) { return m.Page; }); },
          icons: function () { return new Promise(function (resolve, reject) { require(['./ui-icons'], resolve, reject) }).then(function (m) { return m.Icons; }); },
          responsive: function () { return new Promise(function (resolve, reject) { require(['./ui-responsive'], resolve, reject) }).then(function (m) { return m.Responsive; }); },
          shared: function () { return new Promise(function (resolve, reject) { require(['./ui-shared'], resolve, reject) }).then(function (m) { return m.Shared; }); },
          attributes: function () { return new Promise(function (resolve, reject) { require(['./ui-attributes'], resolve, reject) }).then(function (m) { return m.Attributes; }); },
          valueconverters: function () { return new Promise(function (resolve, reject) { require(['./value-converters'], resolve, reject) }).then(function (m) { return m.ValueConverters; }); }
      },
      _a[exports.UIResources.Buttons] = function () { return new Promise(function (resolve, reject) { require(['./ui-buttons'], resolve, reject) }).then(function (m) { return m.Buttons; }); },
      _a[exports.UIResources.Calendar] = function () { return new Promise(function (resolve, reject) { require(['./ui-calendar'], resolve, reject) }).then(function (m) { return m.Calendar; }); },
      _a[exports.UIResources.Card] = function () { return new Promise(function (resolve, reject) { require(['./ui-card'], resolve, reject) }).then(function (m) { return m.Card; }); },
      _a[exports.UIResources.DataPanel] = function () { return new Promise(function (resolve, reject) { require(['./ui-data-panels'], resolve, reject) }).then(function (m) { return m.DataPanels; }); },
      _a[exports.UIResources.Forms] = function () { return new Promise(function (resolve, reject) { require(['./ui-forms'], resolve, reject) }).then(function (m) { return m.Forms; }); },
      _a[exports.UIResources.Gridder] = function () { return new Promise(function (resolve, reject) { require(['./ui-gridder'], resolve, reject) }).then(function (m) { return m.Gridder; }); },
      _a[exports.UIResources.Lists] = function () { return new Promise(function (resolve, reject) { require(['./ui-lists'], resolve, reject) }).then(function (m) { return m.Lists; }); },
      _a[exports.UIResources.Menus] = function () { return new Promise(function (resolve, reject) { require(['./ui-menus'], resolve, reject) }).then(function (m) { return m.Menus; }); },
      _a[exports.UIResources.Panel] = function () { return new Promise(function (resolve, reject) { require(['./ui-panels'], resolve, reject) }).then(function (m) { return m.Panels; }); },
      _a[exports.UIResources.TabPanel] = function () { return new Promise(function (resolve, reject) { require(['./ui-tab-panel'], resolve, reject) }).then(function (m) { return m.TabPanel; }); },
      _a);
