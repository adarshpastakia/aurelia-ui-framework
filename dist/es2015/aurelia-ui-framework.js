import { Container, TaskQueue, BindingEngine, DOM, ViewCompiler, ViewResources, bindable, autoinject, customAttribute, child, computedFrom, customElement, inlineView, bindingMode, children, containerless, viewResources, processContent, observable, valueConverter, ViewSlot, singleton, CompositionEngine } from 'aurelia-framework';
...
import { getExampleNumber, AsYouType, parsePhoneNumberFromString } from 'libphonenumber-js';
...
export { Countries$1 as Countries, UIApplication, UIDataModel, UIDialogService, UIFormat, UIFrameworkConfig, UIHttpService, UINotificationService, broadcast, configure, queueMicroTask, queueTask, serializable, subscribe, subscribeOnce };
