(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var RESOURCE_LOADER = (_a = {
            viewport: function () { return Promise.resolve().then(function () { return uiViewport; }).then(function (m) { return m.Viewport; }); },
            page: function () { return Promise.resolve().then(function () { return uiPage; }).then(function (m) { return m.Page; }); },
            icons: function () { return Promise.resolve().then(function () { return uiIcons; }).then(function (m) { return m.Icons; }); },
            responsive: function () { return Promise.resolve().then(function () { return uiResponsive; }).then(function (m) { return m.Responsive; }); },
            shared: function () { return Promise.resolve().then(function () { return uiShared; }).then(function (m) { return m.Shared; }); },
            attributes: function () { return Promise.resolve().then(function () { return uiAttributes; }).then(function (m) { return m.Attributes; }); },
            valueconverters: function () { return Promise.resolve().then(function () { return valueConverters; }).then(function (m) { return m.ValueConverters; }); }
        },
        _a[exports.UIResources.Buttons] = function () { return Promise.resolve().then(function () { return uiButtons; }).then(function (m) { return m.Buttons; }); },
        _a[exports.UIResources.Calendar] = function () { return Promise.resolve().then(function () { return uiCalendar; }).then(function (m) { return m.Calendar; }); },
        _a[exports.UIResources.Card] = function () { return Promise.resolve().then(function () { return uiCard; }).then(function (m) { return m.Card; }); },
        _a[exports.UIResources.DataPanel] = function () { return Promise.resolve().then(function () { return uiDataPanels; }).then(function (m) { return m.DataPanels; }); },
        _a[exports.UIResources.Forms] = function () { return Promise.resolve().then(function () { return uiForms; }).then(function (m) { return m.Forms; }); },
        _a[exports.UIResources.Gridder] = function () { return Promise.resolve().then(function () { return uiGridder; }).then(function (m) { return m.Gridder; }); },
        _a[exports.UIResources.Lists] = function () { return Promise.resolve().then(function () { return uiLists; }).then(function (m) { return m.Lists; }); },
        _a[exports.UIResources.Menus] = function () { return Promise.resolve().then(function () { return uiMenus; }).then(function (m) { return m.Menus; }); },
        _a[exports.UIResources.Panel] = function () { return Promise.resolve().then(function () { return uiPanels; }).then(function (m) { return m.Panels; }); },
        _a[exports.UIResources.TabPanel] = function () { return Promise.resolve().then(function () { return uiTabPanel; }).then(function (m) { return m.TabPanel; }); },
        _a);
    ...
    var parseDate = function (date) {
        if (isString(date)) {
            var dt = dateFns.startOfMinute(new Date());
    ...
    var DataPanels = [UITreePanel, UIDataGrid, UIColumn, UIDataList, UIDataCard, UIDataTable];
