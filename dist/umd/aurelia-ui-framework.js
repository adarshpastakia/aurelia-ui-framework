(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('aurelia-framework'), require('aurelia-event-aggregator'), require('aurelia-logging'), require('date-fns'), require('kramed'), require('numeral'), require('libphonenumber-js'), require('libphonenumber-js/examples.mobile.json'), require('aurelia-validation'), require('resize-observer-polyfill'), require('aurelia-router'), require('aurelia-metadata'), require('aurelia-fetch-client')) :
    typeof define === 'function' && define.amd ? define(['exports', 'aurelia-framework', 'aurelia-event-aggregator', 'aurelia-logging', 'date-fns', 'kramed', 'numeral', 'libphonenumber-js', 'libphonenumber-js/examples.mobile.json', 'aurelia-validation', 'resize-observer-polyfill', 'aurelia-router', 'aurelia-metadata', 'aurelia-fetch-client'], factory) :
    (global = global || self, factory((global.au = global.au || {}, global.au.uiFramework = {}), global.au, global.au, global.au, global.dateFns, global.kramed, global.numeral, global.libphonenumberJs, global.examples, global.au.validation, global.ResizeObserver, global.au, global.au, global.au));
}(this, function (exports, aureliaFramework, aureliaEventAggregator, aureliaLogging, dateFns, kramed, numeral, libphonenumberJs, examples, aureliaValidation, ResizeObserver, aureliaRouter, aureliaMetadata, aureliaFetchClient) { 'use strict';
