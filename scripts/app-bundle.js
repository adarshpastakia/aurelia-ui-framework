...
define('src/api/datamodel',["require", "exports", "aurelia-framework", "aurelia-ui-framework", "lodash"], function (require, exports, aurelia_framework_1, aurelia_ui_framework_1, _) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('src/api/datasource',["require", "exports", "aurelia-framework", "aurelia-ui-framework"], function (require, exports, aurelia_framework_1, aurelia_ui_framework_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var DataModel = (function () {
        function DataModel(httpClient) {
            ...
            this.sortBy = 'name';
            this.orderBy = 'asc';
            this.ds = new aurelia_ui_framework_1.UIDataSource({ paginate: true, recordsPerPage: 20 });
        }
        DataModel.prototype.attached = function () {
            this.ds.load(Countries.list);
        };
        DataModel.prototype.doFilter = function () {
...
define('src/components/tabpanel',["require", "exports", "aurelia-framework", "aurelia-ui-framework"], function (require, exports, aurelia_framework_1, aurelia_ui_framework_1) {
    ...
    var TabPanel = (function () {
        ...
        TabPanel.prototype.configureRouter = function (config, router) {
            this.router = router;
            config.map([
                {
                    route: ['home', ''],
...
define('src/components/tooltips',["require", "exports", "aurelia-framework", "aurelia-ui-framework"], function (require, exports, aurelia_framework_1, aurelia_ui_framework_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Indicators = (function () {
        function Indicators(httpClient) {
            ...
            this.ribbonTheme = 'dark';
            this.ribbonValue = 'Ribbon Message';
            this.wiki = '';
            this.source = '';
        }
        Indicators.prototype.activate = function () {
        };
        Indicators.prototype.getTip = function (position) {
            return Object.assign({ position: position }, this.tip);
        };
        Indicators = __decorate([
            aurelia_framework_1.autoinject(),
            __metadata("design:paramtypes", [aurelia_ui_framework_1.UIHttpService])
...
define('text!src/api/datasource.html', ['module'], function(module) { module.exports = "<template><ui-page animate><ui-loader busy.bind=ds.busy></ui-loader><x-container page-title=\"Data Source\" wiki.bind=wiki source.bind=source><div class=ui-border-all><ui-toolbar><h6>List</h6><ui-column auto>Showing: ${ds.data.length}/${ds.totalRecords}&nbsp;</ui-column><ui-filler></ui-filler><ui-input-group inner-width=18em plain><ui-input class=ui-spring placeholder=Filter... clear input.trigger=\"doFilter() & debounce\" value.bind=filter><ui-input-addon glyph=icon-fill-search></ui-input-addon></ui-input><ui-dropdown value.bind=sortBy change.trigger=\"ds.sort(sortBy, orderBy)\"><ui-list-item value=iso2>Code</ui-list-item><ui-list-item value=name>Name</ui-list-item></ui-dropdown><ui-input-addon><ui-switch change.trigger=\"ds.sort(sortBy, orderBy)\" theme=ampm on-label=desc off-label=asc on-value=desc off-value=asc value.bind=orderBy></ui-switch></ui-input-addon></ui-input-group><ui-pager store.bind=ds></ui-pager></ui-toolbar></div><div><ui-row middle><ui-column size=lg-6 repeat.for=\"item of ds.data\"><ui-row middle><ui-column auto><div class=ui-display-1 bg-theme=light><ui-glyph class=\"ui-flag ${item.iso3}\"></ui-glyph></div></ui-column><ui-column fill><div>${item.name}</div><div text-theme=darkGray>${item.fullname}</div><small text-info>${item.iso2}&nbsp;&nbsp;&nbsp;&nbsp;${item.iso3}</small></ui-column></ui-row></ui-column></ui-row></div></x-container></ui-page></template>"; });
