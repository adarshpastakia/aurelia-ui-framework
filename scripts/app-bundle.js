...
define('text!src/styles/flags.html', ['module'], function(module) { module.exports = "<template><ui-page animate><x-container page-title=\"Flag Icons\"><style>.flag-card{display:inline-block;border-radius:.5em;margin:.5em;width:128px;text-align:center}.flag-card .ui-flag{margin:.5rem auto;width:32px;height:21px}.flag-card .name{font-size:.8rem;overflow:hidden;line-height:1.5;white-space:nowrap;text-overflow:ellipsis}.flag-card .code{font-size:.6rem}</style><ui-row><div repeat.for=\"key of countries | keys\"><h6 class=x-title>${key}</h6><div class=\"flag-card ui-border-all ui-border-light\" repeat.for=\"c of countries[key]\"><ui-glyph class=\"ui-flag ${c.iso2}\"></ui-glyph><div class=name>${c.name}</div><div class=\"code ui-text-info ui-selectable\">${c.iso2}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${c.iso3}</div></div></div></ui-row></x-container></ui-page></template>"; });
define('text!src/styles/glyphs.html', ['module'], function(module) { module.exports = "<template><ui-page animate><x-container page-title=\"SVG Glyphs\"><style>.glyph-card{display:inline-block;border-radius:.5em;margin:.5em;width:8rem;height:8rem;text-align:center}.glyph-card .ui-icon{margin:1.5rem auto;font-size:2rem}.glyph-card .name{font-size:.8rem;line-height:1.5}</style><h4 class=x-title>Framework Glyphs</h4><div><div repeat.for=\"key of glyphs | keys\"><h6 class=x-title>${key}</h6><ui-row><div class=\"glyph-card ui-border-all ui-border-light\" repeat.for=\"c of glyphs[key]\"><ui-glyph glyph.bind=c class=ui-text-primary></ui-glyph><div class=\"name ui-selectable\">${c}</div></div></ui-row></div></div><h4 class=x-title>Add-On Glyphs</h4><h6 class=x-title><a href=https://icomoon.io target=_blank class=\"ui-link ui-external\">Icomoon Icons</a></h6><ui-row><div class=\"glyph-card ui-border-all ui-border-light\" repeat.for=\"c of fIcomoon | sort\"><ui-glyph class=ui-text-primary glyph.bind=c></ui-glyph><div class=\"name ui-selectable\">${c}</div></div></ui-row><h6 class=x-title><a href=http://hawcons.com target=_blank class=\"ui-link ui-external\">Hawcons Linear Icons</a></h6><ui-row><div class=\"glyph-card ui-border-all ui-border-light\" repeat.for=\"c of fHawLine | sort\"><ui-glyph class=ui-text-primary glyph.bind=c></ui-glyph><div class=\"name ui-selectable\">${c}</div></div></ui-row><h6 class=x-title><a href=http://hawcons.com target=_blank class=\"ui-link ui-external\">Hawcons Filled Icons</a></h6><ui-row><div class=\"glyph-card ui-border-all ui-border-light\" repeat.for=\"c of fHawFill | sort\"><ui-glyph class=ui-text-primary glyph.bind=c></ui-glyph><div class=\"name ui-selectable\">${c}</div></div></ui-row></x-container></ui-page></template>"; });
