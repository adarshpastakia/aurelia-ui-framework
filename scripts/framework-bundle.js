...
function z(a,b){return B(a,b)||[]}function D(a,b){return a.f[b].g?w(a,b)?a.b[b].length:0:w(a,b)?1:0}function y(a,b,c){a.b[b]=c;a.a&&(a.a[b]=c)}function xa(a,b){delete a.b[b];a.a&&delete a.a[b]}function E(a,b){var c=[],d;for(d in b)0!=d&&c.push(new oa(d,b[d]));return new la(a,c)};/*
...
G.prototype.h=function(){var a=za;a||(za=a=E(G,{0:{name:"PhoneNumberDesc",ba:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",c:9,type:String},9:{name:"possible_length",u:!0,c:5,type:Number},10:{name:"possible_length_local_only",u:!0,c:5,type:Number},6:{name:"example_number",c:9,type:String}}));return a};G.h=G.prototype.h;
...
function R(a){if(!w(a,2))return"";var b=""+x(a,2);return w(a,4)&&x(a,4)&&0<C(a,8)?Array(C(a,8)+1).join("0")+b:b}function ab(a,b,c,d){switch(b){case 0:return"+"+a+c+d;case 1:return"+"+a+" "+c+d;case 3:return"tel:+"+a+"-"+c+d;default:return c+d}}
function V(a,b){switch(b){case 4:return x(a,5);case 3:return x(a,4);case 1:return x(a,3);case 0:case 2:return x(a,2);case 5:return x(a,6);case 6:return x(a,8);case 7:return x(a,7);case 8:return x(a,21);case 9:return x(a,25);case 10:return x(a,28);default:return x(a,1)}}function bb(a,b){var c=cb(a,b),c=S(a,C(b,1),c);if(!c)return-1;var d=R(b);return db(d,c)}
function db(a,b){return W(a,x(b,1))?W(a,x(b,5))?4:W(a,x(b,4))?3:W(a,x(b,6))?5:W(a,x(b,8))?6:W(a,x(b,7))?7:W(a,x(b,21))?8:W(a,x(b,25))?9:W(a,x(b,28))?10:W(a,x(b,2))?x(b,18)||W(a,x(b,3))?2:0:!x(b,18)&&W(a,x(b,3))?1:-1:-1}function U(a,b){if(null==b)return null;b=b.toUpperCase();var c=a.a[b];if(!c){c=Ga[b];if(!c)return null;c=(new Da).b(H.h(),c);a.a[b]=c}return c}function W(a,b){var c=a.length;return 0<D(b,9)&&-1==ha(z(b,9),c)?!1:N(C(b,2),a)}
function cb(a,b){if(!b)return null;var c=C(b,1);if(c=K[c])if(1==c.length)c=c[0];else a:{for(var d=R(b),e,f=c.length,g=0;g<f;g++){e=c[g];var h=U(a,e);if(w(h,23)){if(!d.search(x(h,23))){c=e;break a}}else if(-1!=db(d,h)){c=e;break a}}c=null}else c=null;return c}function T(a){return(a=K[a])?a[0]:"ZZ"}function eb(a,b){var c=U(a,b);if(!c)throw Error("Invalid region code: "+b);return C(c,10)}
...
f=e.toString();if(!(O(c)||null!=f&&0<f.length&&M.test(f)))throw Error("Invalid country calling code");f=new J;d&&y(f,5,b);a:{b=e.toString();g=b.search(Qa);if(0<=g&&Wa(b.substring(0,g)))for(var h=b.match(Qa),k=h.length,m=1;m<k;++m)if(null!=h[m]&&0<h[m].length){u(e);e.a(b.substring(0,g));b=h[m];break a}b=""}0<b.length&&y(f,3,b);g=U(a,c);b=new t;h=0;k=e.toString();try{h=gb(a,k,g,b,d,f)}catch(A){if("Invalid country calling code"==A.message&&M.test(k)){if(k=k.replace(M,""),h=gb(a,k,g,b,d,f),!h)throw A;
}else throw A;}h?(e=T(h),e!=c&&(g=S(a,h,e))):(Za(e),b.a(e.toString()),null!=c?(h=C(g,10),y(f,1,h)):d&&xa(f,6));if(2>b.b.length)throw Error("The string supplied is too short to be a phone number");g&&(c=new t,e=new t(b.toString()),hb(e,g,c),a=X(a,e.toString(),g,-1),2!=a&&4!=a&&5!=a&&(b=e,d&&0<c.toString().length&&y(f,7,c.toString())));d=b.toString();a=d.length;if(2>a)throw Error("The string supplied is too short to be a phone number");if(17<a)throw Error("The string supplied is too long to be a phone number");
if(1<d.length&&"0"==d.charAt(0)){y(f,4,!0);for(a=1;a<d.length-1&&"0"==d.charAt(a);)a++;1!=a&&y(f,8,a)}y(f,2,parseInt(d,10));return f}function N(a,b){var c="string"==typeof a?b.match("^(?:"+a+")$"):b.match(a);return c&&c[0].length==b.length?!0:!1};function jb(a){this.ca=RegExp("\u2008");this.ea="";this.m=new t;this.w="";this.i=new t;this.v=new t;this.j=!0;this.$=this.o=this.ga=!1;this.da=L.a();this.s=0;this.b=new t;this.aa=!1;this.l="";this.a=new t;this.f=[];this.fa=a;this.g=kb(this,this.fa)}var lb=new H;y(lb,11,"NA");
...
q("PhoneLib.getNumberInfo",function(a,b){try{var c=L.a(),d=Y(c,a,b),e=R(d),f,g,h=x(d,3),k=Db(a,b),m;a:{var A;w(d,3)?(A=d.clone(),xa(A,3)):A=d;var Q=P(c,A,1).split(Sa);Q[0].length||Q.shift();if(2>=Q.length)m=0;else{if(1==bb(c,d)){var na,Eb=C(d,1);na=Ha[Eb]||"";if(""!=na){m=Q[2].length+na.length;break a}}m=Q[1].length}}0<m?(f=e.substring(0,m),g=e.substring(m),null!=Cb(b,k,!0).match(/^(0)|(\(0)/)&&(f="0"+f)):(f="",g=e);return{countryCode:x(d,1),areaCode:f,phone:g,ext:h}}catch(Fb){return null}});
...
define('aurelia-ui-framework/elements/inputs/ui-list',["require", "exports", "aurelia-framework", "../../utils/ui-event", "../../utils/ui-utils", "lodash"], function (require, exports, aurelia_framework_1, ui_event_1, ui_utils_1, _) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var BaseList = (function () {
        ...
        BaseList.prototype.fireEvent = function (evt) {
            ...
            if (evt.type === 'blur') {
                setTimeout(function () {
                    var item = _['findChildren'](_this.filtered, 'items', 'value', _this.value === null ? '' : _this.value);
                    _this.elValue = '';
                    if (_this.forceSelect && !_this.isTagInput)
                        _this.elValue = item.text;
                }, 500);
                this.element.classList.remove('ui-focus');
                if (el)
                    el.classList.remove('ui-focus');
